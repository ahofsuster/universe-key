						...
						<div class="content">
							<header class="align-center">
								<?php 
									...
									$query = $connect->prepare("select c.sifra, a.citat, b.naziv as kategorija from citatkategorija c 
																inner join citat a
																on c.citat=a.sifra 
								...
								?>
								<a href="new.php" class="button alt margin">Dodaj</a>
								<table>
									<thead>
										<th>Citat</th>
										<th>Kategorija</th>
